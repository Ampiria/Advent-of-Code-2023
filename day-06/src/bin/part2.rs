...
fn parse_tagged_num_list(t: &str, line: &str) -> i64{
...
fn calculate_hold_time((t,d): (&i64, &i64)) -> (u64, u64) {
...
fn part1(input: &str) -> u64 {
    ...
    let time = parse_tagged_num_list("Time:", lines.next().expect("should have a time line").trim());
    let distance = parse_tagged_num_list("Distance: ", lines.next().expect("should have a destination line").trim());
